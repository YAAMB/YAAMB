/*****************************************************************************
* Die Implementierung des TWI_Masters, bis auf process_TWI() und Add_TWI_Command fast alles aus der
* Atmel AppNote  AVR315 - TWI Master Implementation
*
****************************************************************************/
...
{
    TWBR = (F_CPU / TWI_Clock - 16) / 2;		// Set bit rate register (Baudrate). Defined in header file.
    TWSR = 0;									// prescaler
